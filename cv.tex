...
%-------------------- Core ------------------------
\textbf{Core SDK development} \workload{30}
\begin{itemize}
\item \textbf{New Features.}
\item \textbf{Refactoring:} Bug-fix, Readability, Speed Improvements, Memory Leaks, Toolchain...
...
\textbf{Backend Server - Ruby On Rails (public API)} \workload{30}
\begin{itemize}
...
%------------------ Admin sys -----------------------
\item{System Adinistration} \workload{10}
%------------------ Android -----------------------
